...
from anp_server_framework.anp_service.anp_sdk_group_runner import GroupRunner, Message, MessageType, Agent
...
class FileLoggingGroupRunner(GroupRunner):
    ...
    def __init__(self, group_id: str):
        ...
        self.log_dir = UnifiedConfig.resolve_path("demo_anp_sdk/data_tmp_result/group_logs")
