...
from anp_open_sdk.anp_sdk_user_data import get_user_data_manager, LocalUserDataManager
...
class HostedDIDDemo:
    ...
    async def trigger_http_processing(self):
        """触发HTTP方式的申请处理"""
        print("🔧 启动HTTP申请处理...")
        from anp_open_sdk_framework.server.publisher.hosted_did_processor import HostedDIDProcessor
...
async def main():
    ...
    try:
        print("⚙️ 初始化配置...")
        config_file = project_root / "unified_config.yaml"
