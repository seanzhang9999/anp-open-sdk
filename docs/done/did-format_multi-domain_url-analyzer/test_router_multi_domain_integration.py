...
from anp_open_sdk.domain.domain_manager import DomainManager, get_domain_manager
...
class TestRouterMultiDomainIntegration:
    ...
    async def test_router_did_multi_domain_access(self):
        ...
        from anp_open_sdk_framework.server.router.router_did import get_did_document
    ...
    async def test_router_publisher_multi_domain(self):
        ...
        from anp_open_sdk_framework.server.router.router_publisher import get_agent_publishers
        from anp_open_sdk_framework.server.router.router_host import get_hosted_did_document
        from anp_open_sdk.domain.domain_manager import get_domain_manager
        ...
        # 测试代理列表功能
        mock_request_agents = self.create_mock_request(host, port, "/publisher/agents")
