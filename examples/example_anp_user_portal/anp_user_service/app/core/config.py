...
# ANP SDK related configurations - these might come from .env or anp_sdk's own config
# This is a placeholder; you'll need to ensure anp_sdk.config.dynamic_config is loaded correctly.
# For example, if anp_sdk relies on a .env file in the project root:
...
try:
    from anp_sdk.config.legacy.dynamic_config import dynamic_config
