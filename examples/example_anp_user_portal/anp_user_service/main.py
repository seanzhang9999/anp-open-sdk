...
from examples.example_anp_user_portal.anp_user_service.app.routers import chat, auth
...
origins = [
    ...
    "http://localhost:8080", # Common dev anp_server port
...
# Make sure anp_sdk is in PYTHONPATH if not installed
