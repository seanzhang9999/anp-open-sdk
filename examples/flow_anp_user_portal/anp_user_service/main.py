...
from examples.flow_anp_user_portal.anp_user_service.app.routers import chat, auth
...
origins = [
    ...
    "http://localhost:8080", # Common dev anp_servicepoint port
...
# Make sure anp_foundation is in PYTHONPATH if not installed
