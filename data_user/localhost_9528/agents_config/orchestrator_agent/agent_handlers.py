...
async def run_calculator_add_demo():
    ...
    caculator_did = "did:wba:localhost%3A9528:wba:user:28cddee0fade0258"
...
async def run_hello_demo():
    target_did = "did:wba:localhost%3A9528:wba:user:5fea49e183c6c211"
...
async def run_ai_crawler_demo():
    ...
    target_did= "did:wba:localhost%3A9528:wba:user:28cddee0fade0258"
...
async def run_agent_002_demo(sdk, **kwargs):
    ...
    try:
        ...
        target_agent = sdk.get_agent("did:wba:localhost%3A9528:wba:user:5fea49e183c6c211")
        if not target_agent:
...
async def run_agent_002_demo_new():
    ...
    try:
        ...
        result2 = await caller.call_method_by_key(
            "did:wba:localhost%3A9528:wba:user:5fea49e183c6c211::calculate_sum",
            10.5, 20.3
        )
